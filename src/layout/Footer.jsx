...
const Footer = () => {
    return (
        <footer className="jostFont bg-gray-50 pt-5 px-5 md:px-8 lg:px-16 rounded-2xl  max-w-[90rem] mx-auto">
            <div className="w-full max-w-5xl mx-auto">
                <div className="  space-y-3 text-center pb-5">
                    <h2 className="text-lg md:text-xl lg:text-3xl text-blue-500 font-semibold">
                        Get more information
                    </h2>
                    <p className="text-2xl md:text-3xl lg:text-4xl font-medium">
                        About MBBS Admission in Top Medical College
                    </p>
                ...
                <div className="flex md:flex-row flex-col md:justify-between md:items-center gap-5 border-t pb-5 border-[#0005] ">
                    ...
                    <div className="flex flex-col items-center md:items-end gap-5 text-center md:text-right">
                        <div className="flex flex-wrap justify-center md:justify-end items-center gap-3">
                            ...
                            <Link
                                to="mailto:info@mbbswala.in"
                                className="py-2 px-4 border md:text-lg sm:text-base text-sm font-medium rounded-full"
                            >
                                info@mbbswala.in
                            </Link>
                        </div>
                        ...
                        <Link
                            to="https://maps.app.goo.gl/CYCQqH1rkNfSYnJ1A"
                            target="_blank"
                            className="py-2 px-4 border md:text-lg sm:text-base hover:underline text-sm font-medium rounded-full max-w-xs md:max-w-full"
                        >
                            Sf 17, Aakriti Business Centre, Salaiya, Bhopal,
                            (MP), 462026
                        </Link>
