    ...
    <>
      <div className="bg-[#F5F5F5] py-10 p-5 mt-8 rounded-3xl">
        ...
        <div className="flex flex-col lg:flex-row lg:flex-wrap gap-5 justify-start">
          {partners?.map((el) => (
            <div className="bg-white flex gap-2 p-3 lg:p-5 rounded-2xl lg:m-auto">
      ...
      >
        ...
        <BackgroundImageText color="white"/>
          ...
          <h1 className="text-xl sm:text-3xl md:text-6xl lg:text-9xl text-center text-white font-bold"> WALA ? </h1>
