    ...
    >
      <div className="w-full h-full  backdrop-blur-[3px] p-5">
        ...
        <div className="flex flex-col justify-center items-center space-y-3 lg:mt-10">
          ...
          Your Trusted Partner on the Path to Becoming a Doctor. From cracking NEET to securing
your dream medical seat, We're not just counselors; we're your partners in success. MBBS
Wala is here to guide you every step of the way. We offer expert NEET preparation
resources to comprehensive admission counseling, giving you the confidence to navigate
the medical field's challenges. Don't just dream of becoming a doctor – make it happen
with MBBS Wala.
          </p>
        </div>
      </div>
