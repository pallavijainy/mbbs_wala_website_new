        ...
        <section className="lg:py-12 px-2 md:px-8 lg:px-16">
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
                <div className="text-center lg:text-left">
                    <h2 className="text-2xl md:text-5xl font-bold lg:mb-10">
                        Get in touch
                    </h2>
                    <p className="text-gray-600 mb-6 lg:text-xl">
                    ...
                    <div className="space-y-4 lg:space-y-10 mt-4 lg:mt-10">
                        <div className="flex items-center gap-4">
                            ...
                            <Link
                                ...
                                className="text-[#808080] hover:underline text-sm lg:text-lg"
                            >
                                info@mbbswala.in
                            </Link>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="text-[#808080] text-left hover:underline text-sm lg:text-lg"
                            >
                    ...
                    <div className="bg-white rounded-lg p-4 w-full">
                        <div className="">
                            <img
                                src={Contact}
                                alt="Counselor"
                                className="lg:w-full w-100 h-120 lg:h-120 object-contain"
                            />
                        </div>
                    </div>
                </div>
